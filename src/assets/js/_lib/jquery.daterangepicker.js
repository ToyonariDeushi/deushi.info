    ...
    $.fn.dateRangePicker = function (opt) {
        ...
        function calcPosition () {
            if (!opt.inline) {
                ...
                if ($(opt.container).css('position') == 'relative') {
                    ...
                    box.css({
                        top: 70,//offset.top - containerOffset.top + $(self).outerHeight() + 4,
                    ...
                    if (offset.left < 460) //left to right
                    {
                        if (containerOffset) {
                            ...
                            box.css({
                                top: 70,//offset.top + $(self).outerHeight() + parseInt($('body').css('border-top') || 0, 10),
                                // left: offset.left
                                left: offset.left - containerOffset.left - leftIndent
                            });
                        } else {
        ...
        function generateYearElement (date, month) {
            ...
            if (!opt.yearSelect ||
                ...
                return '<div class="month-element">' + fullYear + '年</div>';
            }
        ...
        function getWeekHead () {
            ...
            if (opt.startOfWeek == 'monday') {
                return prepend + '<th>' + translate('week-1') + '</th>' +
                    ...
                    '<th class="saturday">' + translate('week-6') + '</th>' +
                    '<th class="sunday">' + translate('week-7') + '</th>';
            } else {
                return prepend + '<th class="sunday">' + translate('week-7') + '</th>' +
